...
INSERT INTO public.admin_permissions VALUES (59, 'plugin::content-manager.explorer.create', 'api::article.article', '{"fields": ["Title", "body", "featured", "viewsCount", "cover"]}', '[]', '2022-02-02 11:49:22.343', '2022-02-02 11:49:22.343', NULL, NULL);
INSERT INTO public.admin_permissions VALUES (60, 'plugin::content-manager.explorer.read', 'api::article.article', '{"fields": ["Title", "body", "featured", "viewsCount", "cover"]}', '[]', '2022-02-02 11:49:22.358', '2022-02-02 11:49:22.358', NULL, NULL);
INSERT INTO public.admin_permissions VALUES (61, 'plugin::content-manager.explorer.update', 'api::article.article', '{"fields": ["Title", "body", "featured", "viewsCount", "cover"]}', '[]', '2022-02-02 11:49:22.367', '2022-02-02 11:49:22.367', NULL, NULL);
...
INSERT INTO public.admin_permissions VALUES (64, 'plugin::content-manager.explorer.create', 'api::article.article', '{"fields": ["Title", "body", "cover", "featured", "viewsCount"]}', '[]', '2022-02-02 11:52:08.492', '2022-02-02 11:52:08.492', NULL, NULL);
INSERT INTO public.admin_permissions VALUES (65, 'plugin::content-manager.explorer.read', 'api::article.article', '{"fields": ["Title", "body", "cover", "featured", "viewsCount"]}', '[]', '2022-02-02 11:52:08.504', '2022-02-02 11:52:08.504', NULL, NULL);
INSERT INTO public.admin_permissions VALUES (66, 'plugin::content-manager.explorer.update', 'api::article.article', '{"fields": ["Title", "body", "cover", "featured", "viewsCount"]}', '[]', '2022-02-02 11:52:08.514', '2022-02-02 11:52:08.514', NULL, NULL);
...
INSERT INTO public.admin_permissions VALUES (69, 'plugin::content-manager.explorer.create', 'api::article.article', '{"fields": ["Title", "body", "cover", "featured", "viewsCount"]}', '["admin::is-creator"]', '2022-02-02 11:54:01.29', '2022-02-02 11:54:01.29', NULL, NULL);
INSERT INTO public.admin_permissions VALUES (70, 'plugin::content-manager.explorer.read', 'api::article.article', '{"fields": ["Title", "body", "cover", "featured", "viewsCount"]}', '["admin::is-creator"]', '2022-02-02 11:54:01.303', '2022-02-02 11:54:01.303', NULL, NULL);
INSERT INTO public.admin_permissions VALUES (71, 'plugin::content-manager.explorer.update', 'api::article.article', '{"fields": ["Title", "body", "cover", "featured", "viewsCount"]}', '["admin::is-creator"]', '2022-02-02 11:54:01.312', '2022-02-02 11:54:01.312', NULL, NULL);
...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 72, true);
